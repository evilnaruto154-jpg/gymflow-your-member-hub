        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {features.map((f) => (
              <div
                key={f.title}
                className="rounded-2xl border border-border/50 bg-card p-5 sm:p-7 group hover:shadow-lg hover:border-primary/20 transition-all duration-300 hover:-translate-y-1"
              >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {benefits.map((b) => (
              <div
                key={b.title}
                className="rounded-2xl border border-border/50 bg-card p-5 sm:p-6 text-center hover:shadow-lg hover:border-primary/20 transition-all duration-300 hover:-translate-y-1"
              >
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 max-w-4xl mx-auto">
            {plans[billingCycle].map((plan) => (
              <div
                key={plan.name}
                className={`rounded-2xl p-5 sm:p-7 flex flex-col transition-all duration-300 hover:-translate-y-1 ${
                  plan.highlight
