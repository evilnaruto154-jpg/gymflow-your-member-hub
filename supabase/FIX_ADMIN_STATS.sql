-- =============================================================
-- GymFlow — FIX: admin_panel_get_stats + dependencies
...
-- 5. Updated admin_panel_list_profiles with login data columns
...
-- 6. admin_panel_get_stats — THE MISSING FUNCTION causing the error
...
-- 7. Backfill owner roles for any users missing them
...
-- 8. Verification — confirm the function exists
